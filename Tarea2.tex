...
- Permite la conexión entre 2 redes geograficamente distintas\\
- Busca la mejor ruta desde una red a otra mediante criterios\\
- Utiliza un sistema de correccion de errores al transportar paquetes\\
