...
direcciones IP de las interfaces FastEthernet de todos los routers NO
están consideradas en los requerimientos.
%FIG4
	\begin{figure}[H]
	\centering
...
construir esta tabla de rutas resumida.
	...
	\end{figure}
%insertar figura 8
\item Dada la siguiente topología de la Figura 9, encontrar la tabla de rutas 
...
\item Los routers de la Figura 16 se encuentra ejecutando OSPF en el 
area 0. 
